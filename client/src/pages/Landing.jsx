          ...
          <div className="landing-page">
            <section className="landing-content">
              <div className="left-content">
                ...
                <p>
                  Unlock your academic potential with StudySync! Dive into a
                  world of knowledge where we provide digital notes tailored for
                  all college students. Elevate your learning experience today
                  and excel with us!
                </p>
            ...
            <section className="about" id="about">
              ...
              <div>
                <p className="description">
                  StudySync is a dedicated platform designed to empower
                  students, educators, and enthusiasts with a rich collection of
                  academic resources. Our mission is to make learning engaging,
                  accessible, and effective, offering a diverse range of notes,
                  papers, and tools. Join us on a journey towards knowledge,
                  excellence, and educational success.
                </p>
              </div>
            </section>
            {/* working of app */}
            ...
            <section className="download" id="download">
              ...
              <div>
                <p className="description">
                  StudySync is your ultimate companion for academic success.
                  Whether you're a college student or a university enthusiast,
                  this app is designed to help you excel in your studies. With
                  StudySync, you can access a wealth of comprehensive notes and
                  resources on a wide range of subjects right at your
                  fingertips.
                </p>
              </div>
              <a
