...
function Profile() {
  ...
  useEffect(() => {
    ...
    const getUser = async () => {
      try {
        let res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/user/${params.id}`,
          {
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/user/change-password/${params.id}`,
        {
          method: "POST",
          headers: {
